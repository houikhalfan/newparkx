...
function ProjectCreate() {
  const { sites, csrf_token } = usePage().props || {};
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 mt-2">
                Créer un nouveau projet pour un site
              </p>
            </div>
          </div>
        </motion.div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 rounded-xl border transition-all focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                            errors.name
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          className={`w-full pl-10 pr-8 py-3 rounded-xl border transition-all focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent appearance-none cursor-pointer ${
                            errors.site_id
                              ? "border-red-300 dark:border-red-600 bg-red-50 dark:bg-red-900/20"
                              : "border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700"
                          } text-slate-900 dark:text-white`}
...
ProjectCreate.layout = (page) => <AdminLayout children={page} />;
