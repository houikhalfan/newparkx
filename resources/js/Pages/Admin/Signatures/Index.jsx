...
function AdminSignaturesIndex() {
  ...
  // Controlled filters (so typing updates state)
  ...
  return (
    <div className="-m-4 md:-m-8 bg-white min-h-[calc(100vh-3.5rem)] p-4 md:p-8">
      ...
      <form onSubmit={submit} className="mb-5 flex flex-wrap items-center gap-2">
        ...
        <button type="submit" className="inline-flex items-center gap-2 rounded-lg bg-black text-white px-4 py-2 text-sm font-medium hover:opacity-90">
          Filtrer
        </button>
      </form>
