...
/* ================================= PAGE ================================== */
export default function PermisTravailSecuritaireSignHSE({
  permis,
  flash = {},
  readonly = false,
  showSignatureHSE = true,
}) {
  ...
  /* ------------------------------ Form State ------------------------------ */
  const initialState = {
    // HSE ParkX Signatures (editable by HSE responsible)
    ...
    hse_parkx_commentaires: permis?.hse_parkx_commentaires || "",

    // All other fields (readonly - loaded from DB)
  ...
  Object.keys(data).forEach(key => {
    if (key === 'hse_parkx_file' && data[key] instanceof File) {
      // Append the file
  ...
  post(route("hseResponsible.permis-travail-securitaire.sign", permis.id), {
    data: formData,
    forceFormData: true, // This ensures FormData is used
    onSuccess: () => {
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center space-x-3 sm:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 font-medium">Validation HSE Manager ParkX</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 w-full sm:w-auto">
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-sm sm:text-base">Retour aux Permis</span>
                  </a>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-slate-800">
                    <p className="text-xs sm:text-sm font-medium">HSE Manager</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-sm sm:text-xl text-slate-600 max-w-3xl mx-auto px-2">
              Signature HSE Manager ParkX pour le permis de travail sécuritaire
            </p>
          </motion.div>
          ...
          <form onSubmit={onSubmit} className="space-y-4 sm:space-y-6">
            ...
            {/* HSE ParkX Signatures - Only this section is editable */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <FormCard title="Validation HSE Manager ParkX">
                <Row label="HSE Manager ParkX">
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                    <div className="space-y-3">
                      <Text
                        ref={hseParkxNomRef}
                        placeholder="Nom HSE Manager ParkX"
                        disabled={false}
                      ...
                      />
                      <Area
                        placeholder="Commentaires HSE (optionnel)"
                        disabled={false}
                        value={data.hse_parkx_commentaires || ""}
                        onChange={(e) => setData("hse_parkx_commentaires", e.target.value)}
                        rows={3}
                      />
                    </div>
                    <SignaturePicker
                      id="sig_hse_parkx"
                      label="Signature HSE Manager (JPG/PNG)"
                ...
                <Row label="Construction Manager ParkX (déjà signé)">
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 opacity-60">
                    <div className="space-y-3">
                      <Text disabled value={data.cm_parkx_nom} />
                      <Text type="date" disabled value={data.cm_parkx_date} />
                    </div>
                    {data.cm_parkx_file && (
                      <img
                        src={`/storage/${data.cm_parkx_file}`}
            ...
            {!readonly && showSignatureHSE && (
              <div className="flex items-center justify-end gap-3 pb-2 sticky bottom-4 bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20">
                ...
                >
                  {processing ? "Signature en cours…" : "Signer le Permis"}
                </button>
              </div>
            )}
          </form>
