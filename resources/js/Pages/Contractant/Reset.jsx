      ...
      <div className="relative flex min-h-screen items-center justify-center px-4">
        <div className="w-full max-w-xl">
          <div className="rounded-2xl bg-white/60 backdrop-blur-xl border border-white/20 shadow-2xl ring-1 ring-black/5 p-8 sm:p-10">
            ...
            <h1 className="text-xl font-semibold text-center">Nouveau mot de passe (Contractant)</h1>

            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <input type="hidden" name="token" value={data.token} />
              <div>
                <label className="block text-sm font-medium text-gray-800">Adresse e-mail</label>
                <input
                  type="email"
                  value={data.email}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-800">Confirmer le mot de passe</label>
                <input
                  type="password"
            ...
            <div className="mt-6 text-center">
              <a href={route('contractant.login')} className="text-sm text-gray-700 underline-offset-2 hover:text-gray-900">
