...
export default function ContractorReset({ token, email }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    post(route('contractant.password.update'), {
      // Backend redirects to /login?tab=contractor&reset_done=contractor
      preserveScroll: true,
    });
  };
        ...
        >
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              >
                Contractant - Définissez votre nouveau mot de passe sécurisé
              </motion.p>
            </div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-4 rounded-2xl border-2 border-white/30 bg-white/15 backdrop-blur-sm text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all font-medium"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-4 rounded-2xl border-2 border-white/30 bg-white/15 backdrop-blur-sm text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all font-medium"
