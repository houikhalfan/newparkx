                        ...
                        <div className="max-w-7xl mx-auto">
                            ...
                            >
                                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                                    <span className="bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">Statistiques HSE</span>
                                </h1>
                                        {canSubmit ? (
                                    <p className="text-gray-300 text-lg">Soumettez vos statistiques de santé, sécurité et environnement</p>
                                ) : (
                                    <div className="mt-4">
                                        <p className="text-red-400 font-medium text-lg">Vous avez déjà soumis vos statistiques pour aujourd'hui</p>
                                        <p className="text-gray-400 text-sm mt-2">Vous pouvez consulter et modifier vos statistiques dans l'historique</p>
                                            </div>
                                        )}
                            </motion.div>
                            ...
                            >
                                    ...
                                    className="group flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-emerald-500/20 border border-cyan-500/30 rounded-xl text-cyan-300 hover:from-cyan-500/30 hover:to-emerald-500/30 hover:border-cyan-400/50 hover:text-cyan-200 transition-all duration-300 backdrop-blur-sm"
                                        >
                            ...
                            {canSubmit ? (
                                ...
                                >
                                    <div className="flex items-center space-x-3 mb-6">
                                        ...
                                        <h2 className="text-2xl font-bold text-white">2) Indicateurs (aperçu)</h2>
                                        </div>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="bg-gradient-to-br from-cyan-500/10 to-cyan-600/10 p-6 rounded-xl border border-cyan-500/20 text-center">
                                            <div className="text-3xl font-bold text-cyan-400 mb-2">{trir.toFixed(2)}</div>
                                            <div className="text-sm font-medium text-cyan-300">TRIR</div>
                                            <div className="text-xs text-cyan-400/70 mt-1">Total Recordable Incident Rate</div>
                                        </div>
                                        <div className="bg-gradient-to-br from-emerald-500/10 to-emerald-600/10 p-6 rounded-xl border border-emerald-500/20 text-center">
                                            <div className="text-3xl font-bold text-emerald-400 mb-2">{ltir.toFixed(2)}</div>
                                            <div className="text-sm font-medium text-emerald-300">LTIR</div>
                                            <div className="text-xs text-emerald-400/70 mt-1">Lost Time Incident Rate</div>
                                        </div>
                                        <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 p-6 rounded-xl border border-purple-500/20 text-center">
                                            <div className="text-3xl font-bold text-purple-400 mb-2">{dart.toFixed(2)}</div>
                                            <div className="text-sm font-medium text-purple-300">DART</div>
                                            <div className="text-xs text-purple-400/70 mt-1">Days Away, Restricted, or Transferred</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Accident mortel</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Accident avec arrêt</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Accident avec soins médicaux</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Accident avec restriction temporaire</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Presque accident</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Dommage matériel</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Incident environnemental</label>
                                            <input
                                                type="number"
                                    ...
                                    <div className="mt-4">
                                        <label className="block text-sm font-medium text-gray-300 mb-2">Rapport d'accident (PDF)</label>
                                        ...
                                        {uploadedFiles.accident_report ? (
                                            <div className="flex items-center justify-between p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <p className="text-emerald-300 text-sm font-medium">{uploadedFiles.accident_report.name}</p>
                                                        <p className="text-emerald-400 text-xs">{(uploadedFiles.accident_report.size / 1024).toFixed(1)} KB</p>
                                                    </div>
                                                </div>
                                                <motion.button
                                            ...
                                            accept=".pdf"
                                                ...
                                                whileTap={{ scale: 0.98 }}
                                                className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/50 transition-all duration-300 hover:bg-white/10 hover:border-cyan-400/50 file:bg-cyan-500/20 file:border-0 file:rounded-lg file:px-3 file:py-1 file:text-cyan-300 file:text-sm file:mr-3 file:hover:bg-cyan-500/30 file:transition-all file:duration-300"
                                            />
                                        )}
                                        
                                        {errors.accident_report && <p className="text-red-400 text-sm mt-1">{errors.accident_report}</p>}
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Nombre des sensibilisations</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Total des personnes sensibilisées</label>
                                            <input
                                                type="number"
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Total des inductions (personnes)</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Total des personnes formées</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Volume horaire des inductions (heures)</label>
                                            <input
                                                type="number"
                                                step="0.01"
                                ...
                                >
                                    ...
                                    {/* Excavation */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Excavation</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Nombre des sessions</label>
                                                <input
                                                    type="number"
                                                    value={data.excavation_sessions}
                                                    onChange={(e) => handleFileUpload('excavation_sessions', parseInt(e.target.value) || 0)}
                                                    className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400/50 transition-all duration-300 file:bg-cyan-500/20 file:border-0 file:rounded-lg file:px-3 file:py-1 file:text-cyan-300 file:text-sm file:mr-3"
                                                    min="0"
                                                />
                                            </div>
                                            <div>
                                    ...
                                    {/* Points chauds */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Points chauds</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Nombre des sessions</label>
                                                <input
                                    ...
                                    {/* Espace confiné */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Espace confiné</h3>
                                    ...
                                    {/* Levage */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Levage</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Nombre des sessions</label>
                                                <input
                                    ...
                                    {/* Travail en hauteur */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Travail en hauteur</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Nombre des sessions</label>
                                                <input
                                    ...
                                    {/* SST */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">SST</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Nombre des sessions</label>
                                                <input
                                    ...
                                    <div className="mt-6 p-6 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-xl">
                                        <h3 className="text-lg font-semibold text-cyan-300 mb-4">Totaux des formations</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div className="text-center bg-gradient-to-br from-cyan-500/10 to-cyan-600/10 p-6 rounded-xl border border-cyan-500/20">
                                                ...
                                                <div className="text-sm text-cyan-300">Total des séances de formations</div>
                                            </div>
                                            <div className="text-center bg-gradient-to-br from-emerald-500/10 to-emerald-600/10 p-6 rounded-xl border border-emerald-500/20">
                                                <div className="text-2xl font-bold text-emerald-400">{totalParticipants}</div>
                                                <div className="text-sm text-emerald-300">Total des participants</div>
                                            </div>
                                            <div className="text-center bg-gradient-to-br from-purple-500/10 to-purple-600/10 p-6 rounded-xl border border-purple-500/20">
                                                <div className="text-2xl font-bold text-purple-400">{totalHeuresFormations.toFixed(2)}</div>
                                                <div className="text-sm text-purple-300">Total heures de formations</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    {/* Permis */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Permis</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                            <div>
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Consignation (LOTO)</label>
                                                <input
                                                    type="number"
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Électrique sous tension</label>
                                                <input
                                                    type="number"
                                        ...
                                        {/* Permis Totals */}
                                        <div className="mt-6 p-6 bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-xl">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div className="text-center bg-gradient-to-br from-orange-500/10 to-orange-600/10 p-4 rounded-xl border border-orange-500/20">
                                                    <div className="text-lg font-semibold text-orange-300">
                                                        Permis spécifiques total: {permisSpecifiques}
                                                    </div>
                                                </div>
                                                <div className="text-center bg-gradient-to-br from-red-500/10 to-red-600/10 p-4 rounded-xl border border-red-500/20">
                                    ...
                                    {/* PTSR */}
                                    <div>
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">PTSR</h3>
                                ...
                                >
                                    <div className="flex items-center space-x-3 mb-6">
                                        ...
                                        <h2 className="text-2xl font-bold text-white">8) Engins & Matériels et équipements spécifiques</h2>
                                    </div>
                                    
                                    {/* Engins sur site */}
                                    <div className="mb-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Engins sur site</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            <div>
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Camion 8×4</label>
                                                <input
                                                    type="number"
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Finisseur d'enrobés</label>
                                                <input
                                                    type="number"
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Pompe à béton</label>
                                                <input
                                                    type="number"
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Nacelle à ciseaux</label>
                                                <input
                                                    type="number"
                                    ...
                                    <div>
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Matériels spécifiques</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Compresseur d'air</label>
                                                <input
                                                    type="number"
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">Hygiène & base vie</label>
                                            <input
                                                type="number"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-300 mb-2">EPI</label>
                                            <input
                                                type="number"
                                    ...
                                    <div className="mt-6">
                                        <h3 className="text-lg font-medium text-cyan-300 mb-4">Rapports d'inspection (PDF)</h3>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                {uploadedFiles.inspection_generales_report ? (
                                                    <div className="flex items-center justify-between p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                                                        <div className="flex items-center space-x-3">
                                                            <FileText className="w-5 h-5 text-emerald-400" />
                                                            <div>
                                                                <p className="text-emerald-300 text-sm font-medium">{uploadedFiles.inspection_generales_report.name}</p>
                                                                <p className="text-emerald-400 text-xs">{(uploadedFiles.inspection_generales_report.size / 1024).toFixed(1)} KB</p>
                                                            </div>
                                                        </div>
                                                        <motion.button
                                                            whileHover={{ scale: 1.05 }}
                                                ...
                                                {errors.inspection_generales_report && <p className="text-red-400 text-sm mt-1">{errors.inspection_generales_report}</p>}
                                            </div>
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Rapport hygiène & base vie</label>
                                                <motion.input
                                                    type="file"
                                                    accept=".pdf"
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-300 mb-2">Rapport EPI inspections</label>
                                                <motion.input
                                                    type="file"
                                                    accept=".pdf"
                                ...
                                <div className="flex justify-center mt-8">
                                    <motion.button
                                        ...
                                        whileHover={{ scale: 1.05 }}
                                        whileTap={{ scale: 0.95 }}
                                        className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-emerald-500 rounded-xl text-white font-semibold text-lg shadow-2xl hover:shadow-cyan-500/25 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                                    >
                                        <div className="flex items-center space-x-3">
                                        ...
                                        {/* Button Glow Effect */}
                                        <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-cyan-400 to-emerald-400 opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300" />
                                    </motion.button>
                                </div>
                            </motion.form>
                            ) : (
                                ...
                                >
                                    ...
                                    >
                                        <div className="p-4 bg-gradient-to-br from-cyan-500/20 to-emerald-500/20 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center">
                                            <BarChart3 className="w-10 h-10 text-cyan-400" />
                                        </div>
                                        <h3 className="text-2xl font-bold text-white mb-4">Statistiques déjà soumises</h3>
                                        <p className="text-gray-300 mb-8">
                                            ...
                                            <Link
                                                href={route('contractant.hse-statistics.history')}
                                            className="group inline-flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-emerald-500/20 border border-cyan-500/30 rounded-xl text-cyan-300 hover:from-cyan-500/30 hover:to-emerald-500/30 hover:border-cyan-400/50 hover:text-cyan-200 transition-all duration-300 backdrop-blur-sm"
                                            >
                                            <History className="w-5 h-5" />
