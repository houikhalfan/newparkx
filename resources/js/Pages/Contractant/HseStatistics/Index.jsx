                            ...
                            <div className="mb-8">
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        {canSubmit ? (
                                            <p className="text-gray-600 mt-2">Soumettez vos statistiques de santé, sécurité et environnement</p>
                                        ) : (
                                            <div className="mt-2">
                                                <p className="text-red-600 font-medium">Vous avez déjà soumis vos statistiques pour aujourd'hui</p>
                                                <p className="text-gray-600 text-sm">Vous pouvez consulter et modifier vos statistiques dans l'historique</p>
                                            </div>
                                        )}
                                    </div>
                            ...
                            {canSubmit ? (
                                ...
                                <div className="text-center py-12">
                                    <div className="max-w-md mx-auto">
                                        ...
                                        <h3 className="text-xl font-semibold text-gray-900 mb-2">Statistiques déjà soumises</h3>
