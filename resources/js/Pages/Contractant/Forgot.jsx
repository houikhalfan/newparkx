            ...
            <div className="w-full rounded-3xl bg-white/15 backdrop-blur-2xl border-2 border-white/30 shadow-2xl ring-2 ring-white/20 p-8 sm:p-10 min-w-[400px] max-w-[500px]">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <img src="/images/logo.png" alt="ParkX" className="h-12 w-auto" />
                ...
                <p className="text-blue-200 text-center">
                  Contractant - Entrez votre adresse e-mail pour recevoir un lien de réinitialisation
                </p>
              </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={processing}
                  className="w-full rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 font-semibold transition-all hover:from-orange-600 hover:to-red-600 disabled:opacity-70 shadow-xl hover:shadow-2xl flex items-center justify-center gap-2 text-lg"
                >
                  {processing ? (
                    <>
