...
class MaterialRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'carte_grise'             => ['required', 'file', 'mimes:pdf,doc,docx,png,jpg,jpeg', 'max:10240'], // ✅ new
        ...
        $cg  = $request->file('carte_grise')->store('materials/carte_grise', 'public'); // ✅ new
